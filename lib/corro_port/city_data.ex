defmodule CorroPort.CityData do
  @cities %{
    ams: {5, 52},
    iad: {-77, 39},
    atl: {-84, 34},
  ...
  # Seattle for dev
  defp handle_special_regions("dev"), do: {-122, 47}
  # Off-screen
  defp handle_special_regions("unknown"), do: {-190, 0}
  # Default off-screen
  defp handle_special_regions(_), do: {-190, 0}
end
