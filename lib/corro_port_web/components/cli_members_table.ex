defmodule CorroPortWeb.CLIMembersTable do
  ...
  def display(assigns) do
      ...
      <div class="card-body">
        <div class="flex items-center justify-between mb-4">
          ...
          <div class="flex gap-2">
            ...
            <span
              :if={@cli_member_data && @cli_member_data.status == :fetching}
        ...
        <div :if={@cli_member_data} class="mb-4">
          <div class="flex items-center gap-4 text-sm">
            ...
            <div :if={@cli_member_data.last_updated}>
              ...
              <span class="text-xs">
                {Calendar.strftime(@cli_member_data.last_updated, "%H:%M:%S")}
              </span>
            </div>
            <div>
    ...
    <!-- Empty State -->
        <div
          :if={@cli_member_data && @cli_member_data.members == [] && !@cli_error}
    ...
    <!-- Loading State -->
        <div
          :if={!@cli_member_data || @cli_member_data.status == :initializing}
